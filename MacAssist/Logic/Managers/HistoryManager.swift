...
struct Conversation: Codable, Identifiable, Hashable, Equatable {
    ...
    var timestamp: Date
    var storedTitle: String? // NEW: Title generated by LLM
    var summary: String?     // NEW: Summary generated by LLM
    
    var title: String {
        // Use the stored title if available
        if let storedTitle = storedTitle, !storedTitle.isEmpty {
            return storedTitle
        }
        
        // Fallback: Find the first user message to use as a title
